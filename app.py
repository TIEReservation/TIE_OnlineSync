...
def show_user_management():
    ...
    with st.form("create_user_form", clear_on_submit=False):
        ...
        if new_role == "Admin":
            ...
            default_screens = [s for s in all_screens if s not in ["User Management", "Log Report","Expense Tracker"]]
            ...
            default_screens = ["Daily Status", "Night Report Dashboard", "Monthly Consolidation", "Accounts Report","Expense Tracker"]
        else:
            default_screens = [s for s in all_screens if s not in ["Daily Management Status", "Night Report Dashboard", "Date-wise Booking Report","Date-wise Check-in Report", "Analytics", "Inventory Dashboard", "Summary Report", "Target Achievement", "User Management", "Log Report","Expense Tracker"]]
