...
def show_new_reservation_form():
    ...
    with col1:
        property_options = [
            ...
            "La Millionare Resort", "Le Park Resort", "Villa Shakti", "Property 16"
        ]
    ...
    with col3:
        ...
        room_type = st.selectbox("Room Type", ["Double", "Triple", "Family", "1BHK", "2BHK", "3BHK", "4BHK", "Superior Villa", "Other"], key=f"{form_key}_roomtype")
        if room_type == "Other":
    ...
    with col4:
        ...
        balance_mop = st.selectbox("Balance MOP", ["Cash", "Card", "UPI", "Bank Transfer", "Pending", "Other"], key=f"{form_key}_balmop")
    ...
    with col5:
        ...
        mob = st.selectbox("MOB (Mode of Booking)", ["Direct", "Online", "Agent", "Walk-in", "Phone", "Website", "Booking-Drt", "Social Media", "Stay-back", "TIE-Group", "Others"], key=f"{form_key}_mob")
        if mob == "Others":
...
def show_edit_form(edit_index):
    ...
    with col1:
        ...
        property_name = st.selectbox("Property Name", property_options, index=property_options.index(reservation["Property Name"]), key=f"{form_key}_property")
